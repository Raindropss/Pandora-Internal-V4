...
namespace Settings
{
	void LoadSettings( string szIniFile )
	{
		...
		Misc::misc_slidewalk = CSX::Cvar::LoadCvar( MISC_TEXT , CVAR_MISC_SLIDEWALK , Misc::misc_slidewalk ) != false;
	...
	void SaveSettings( string szIniFile )
	{
		...
		CSX::Cvar::SaveCvar( MISC_TEXT , CVAR_MISC_SLIDEWALK , Misc::misc_slidewalk);
