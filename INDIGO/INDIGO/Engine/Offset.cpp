...
//[/swap_lines]
		...
		bool Initialize()
		{
			...
			Entity::deadflag = g_NetVar.GetOffset(BASE_PLAYER, BASE_PLAYER_DEADFLAG);

			Entity::m_flC4Blow = g_NetVar.GetOffset("DT_PlantedC4", "m_flC4Blow");
			...
			Entity::m_nRenderMode = g_NetVar.GetOffset(BASE_ENTITY, "m_nRenderMode");
			Entity::m_MoveType = Entity::m_nRenderMode + 1;
