...
//[junk_enable /]
	...
	{
		return *(float*)((DWORD)this + Offset::Entity::m_flC4Blow);
	}
	...
	{
		return ((DWORD)this + (DWORD)Offset::Entity::m_lifeState == LIFE_ALIVE && GetHealth() > 0);
	}

	int CBaseEntity::GetMoveType() {
		return *(int*)((DWORD)this + Offset::Entity::m_MoveType);
	}
	...
	ABaseWeapon* CBaseEntity::GetBaseWeapon()
	{
		return (ABaseWeapon*)Interfaces::EntityList()->GetClientEntityFromHandle( ( PVOID )*(PDWORD)GetActiveWeapon() );
	}
