...
//[swap_lines]
	...
	IMDLCache*			Interfaces::g_pModelCache = nullptr;
//[/swap_lines]
//[junk_enable /]
	...
	IMDLCache* Interfaces::ModelCache()
	{
		if (!g_pModelCache)
		{
			CreateInterfaceFn pfnFactory = CaptureFactory("datacache.dll");
			g_pModelCache = CaptureInterface<IMDLCache>(pfnFactory, MDLCACHE_INTERFACE_VERSION);
		}
		return g_pModelCache;
	}
