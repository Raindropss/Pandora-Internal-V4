...
//[junk_enable /]
	...
	void ClanTag()
	{
		...
		case 2:
		{
			SetMyClanTag("PandoraV4", "PandoraV4");
			break;
		}
		case 3:
		{
			SetMyClanTag("PandoraV4 \r", "PandoraV4 only");
			break;
		}
		case 4:
		{
		...
		case 6:
		{
			...
			case 0:
			{
				SetMyClanTag("         ", "Pandora");
				break;
			}
			case 1:
			{
				SetMyClanTag("        P", "Pandora");
				break;
			}
			case 2:
			{
				SetMyClanTag("       Pa", "Pandora");
				break;
			}
			case 3:
			{
				SetMyClanTag("      Pan", "Pandora");
				break;
			}
			case 4:
			{
				SetMyClanTag("     Pand", "Pandora");
				break;
			}
			case 5:
			{
				SetMyClanTag("    Pando", "Pandora");
				break;
			}
			case 6:
			{
				SetMyClanTag("   Pandor", "Pandora");
				break;
			}
			case 7:
			{
				SetMyClanTag("  Pandora", "Pandora");
				break;
			}
			case 8:
			{
			...
			case 9:
			{
				SetMyClanTag("andora   ", "Pandora");
				break;
			}
			case 10:
			{
				SetMyClanTag("ndora    ", "Pandora");
				break;
			}
			case 11:
			{
				SetMyClanTag("dora     ", "Pandora");
				break;
			}
			case 12:
			{
				SetMyClanTag("ora      ", "Pandora");
				break;
			}
			case 13:
			{
				SetMyClanTag("ra       ", "Pandora");
				break;
			}
			case 14:
			{
				SetMyClanTag("a        ", "Pandora");
				break;
			}
			case 15:
			{
	...
	{
		std::vector<std::string> chatspam = { "Pandora Private Tapping Nonames Since 1980" };
	...
	void ChatSpamRandom()
	{
		std::vector<std::string> chatspamsss = { "Pandora Private v4 #1" , "Nice P2C, Refund b4 its too late" , "How to change bot difficulty?","You should RQ before i media you" };
